...
half3 GTGlobalIllumination(GTBRDFData brdfData, half3 bakedGI, half occlusion, half3 normalWS, half3 viewDirectionWS, float3 worldPosition)
{
    half3 reflectVector = BoxProjectedCubemapDirection(reflect(-viewDirectionWS, normalWS), worldPosition, unity_SpecCube0_ProbePosition, unity_SpecCube0_BoxMin, unity_SpecCube0_BoxMax);  ;
